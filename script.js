...
function renderUI(value) {
    if(value.trim()==""){
        ...
        inResponse.innerHTML = `<p>Zəhmət olmasa axtarış qutusunu boş qoymayın</p>`;
        return;
    }
    ...
    `;
        ...
        console.error( error);
        inResponse.innerHTML = `<p>Belə bir film tapılmadı zəhmət olmas adın duzgun olub olmamasini yoxlayın</p>`;
    });
}
